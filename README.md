...
|:-------------------------------------------------------------------------------------------:|:---------------------------:|:-----------------------------:|
| نقد اجتماعی، سیاسی یا فرهنگی به صورت غیرمستقیم و با کنایه‌زنی به مسائل که نیازمند اصلاح هستند.         | **Satire**                  | **طنز هجو**                   |
...
| طنزی که به ساختارهای مرسوم اجتماعی یا هنری حمله می‌کند و تناقضات دنیای مدرن را برجسته می‌کند.             | **Postmodern Satire**       | **طنز پست‌مدرن**              |
