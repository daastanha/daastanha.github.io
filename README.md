...
A personal reading tracker. Books are stored in [`data.csv`](data.csv) and rendered as a searchable, sortable table at the site.

Live site: [daastanha.github.io](https://daastanha.github.io)
